...
Command status prefers editing the original command message. If the command message can no longer be edited, the bot sends a normal status message instead.
